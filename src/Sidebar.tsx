...
export default function Sidebar({ addBlankSlide }: SidebarProps) {
  ...
  return (
    <div style={{ display: "flex" }}>
      {isExpanded ? (
        <div
          className="border-black border-end border-5 bg-transparent p-5 d-flex flex-column vh-100"
          style={{ width: "20vw", maxWidth: "20vw" }} // Set width to 20vw
        >
          <div>
            <form>
              <input
              ...
              <button
                className="btn btn-primary border border-black border-5 w-100"
